...
const commonStyles = `min-h-[70px] sm:px-0 px-2 sm:min-w-[120px]
  flex justify-center items-center border-[0.5px] border-gray-400
      ...
      <div className='flex mf:flex-row flex-col justify-between items-start md:p-20 py-12 px-4'>
        <div className='flex flex-1 justify-start flex-col mf:mr-10'>
          ...
          {!currentAccount && <button
            ...
            className='flex flex-row justify-center items-center my-5 p-3 rounded-full
               bg-[#2952e3] cursor-pointer hover:bg-[#2546bd]'
          >
            <p className='text-white text-base text-bold'>
              Connect Wallet
            </p>
        ...
        <div className='flex flex-col flex-1 items-center w-full mf:mt-0 mt-10'>
          ...
          <div className='p-5 sm:w-96 flex flex-col justify-start items-center w-full blue-glassmorphism '>
            ...
            <Input placeholder={'Enter message'} name='message' handleChange={handleChange} type='text' />
