  ...
  return (
    <div
      className='w-full flex md:justify-center
        justify-between items-center flex-col p-4 gradient-bg-footer'
    >
      <div
      ...
      >
        ...
        <div
          className='flex flex-1 justify-evenly items-center flex-wrap
              sm:mt-0 mt-5 w-full'
        >
          <p className='text-white text-base mx-2 cursor-pointer'>
            Market
          </p>
          <p className='text-white text-base mx-2 cursor-pointer'>
            Exchange
      ...
      <div className='flex justify-center items-center flex-col mt-5'>
        ...
        <p className='text-white text-small text-center'>info@crypto.com</p>

      </div>
      <div className='sm:w-[90%] w-full h-[0.25px] bg-gray-400 mt-5' />
      <div className='sm:w-[90%] w-full justify-between items-center mt-3'>
        <p className='text-white text-small text-center'>@krypto 2022</p>
